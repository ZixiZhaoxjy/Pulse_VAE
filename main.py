...
if __name__ == "__main__":
    ...
    for case_index, train_SOC_values in enumerate(train_SOC_values_cases):
        ...
        # Augment data
        augmented_data, augmented_Fts, repeated_conditions_denormalized, history, train_augmented_features = augment_data(
            vae,
            train_Fts,
            train_condition,
        ...
        masked_augmented_Fts, masked_augmented_SOH, masked_augmented_Fts_dir, masked_augmented_SOH_dir = preprocess(
            case_index, hyperparams, test_condition, test_Fts, train_SOC_values, train_SOC_values_cases, augmented_Fts)


        print(len(augmented_data),len(masked_augmented_Fts),len(masked_augmented_SOH))
        ...
        mape_results_phase1, mape_results_phase2, std_results_phase1, std_results_phase2 = run_SOH_experiments(
            ...
            hyperparams['all_SOC_values'], data, augmented_data, masked_augmented_Fts, test_condition)
